...
<?php
   ...
   $sql = 'SELECT Animal_ID , gender,age,color,breed FROM ANIMAL WHERE type = "Cat" AND Animal_ID = 3 AND Adopter_ID is null';
   ...
   ?>
   <img src="kitten1.jpg" alt="cat" width="200" height= "200" style="position:absolute; TOP:350px; LEFT:800px">
   </div>
...
<form action="insertc1.php" method="post" align = center>
	<p>
