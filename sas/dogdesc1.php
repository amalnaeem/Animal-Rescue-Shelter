...
<?php
   ...
   $sql = 'SELECT Animal_ID , gender,age,color,breed FROM ANIMAL WHERE type = "dog" AND Animal_ID = "1" AND Adopter_ID is null';
   ...
   {
	   ?>
  <br><br><h1>Animal Found A Home ☻</h1>
  <?php
   }
   if(! $retval ) {
...
if($num_rows != 0) {
?>
<img src="dog1.jpg" alt="dog" width="200" height= "200" style="position:absolute; TOP:350px; LEFT:800px">
   </div>
<br><br><br> <h2  align=center>Kindly Fill This Adoption Form To Register</h2> 
<form action="insertd1.php" method="post" align = center>
	<p>
