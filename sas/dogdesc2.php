...
<?php
   ...
   $sql = 'SELECT Animal_ID , gender,age,color,breed FROM animal WHERE type = "dog" AND Animal_ID = 2 AND Adopter_ID is null';
   ...
   ?>
   <img src="dog2.jpg" alt="dog" width="200" height= "200" style="position:absolute; TOP:350px; LEFT:800px">
   </div>
...
<form action="insertd2.php" method="post" align = center>
	<p>
